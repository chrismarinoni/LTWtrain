  ...
  <body class="text-center">
    ...
    <script type="text/javascript">
      $("#register").click(function () {
        $("#form-signin").slideUp(1000);
        $("#form").animate({maxWidth: '+=300px'},1000,'linear',function(){ $("#form-register").slideDown(1000);});

      });
      $("#signin-back").click(function () {
        $("#form-register").slideUp(1000);
        $("#form").animate({maxWidth: '-=300px'},1000,'linear',function(){ $("#form-signin").slideDown(1000);});
      });
    </script>
